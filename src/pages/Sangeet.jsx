...
export default function Sangeet() {
  return (
    <section className="page center">
      <img className="event-graphic" src="https://static.vecteezy.com/system/resources/thumbnails/046/448/693/small/indian-couple-illustration-south-india-bride-wearing-wedding-dresses-free-vector.jpg" alt="Sangeet celebration" />
      <h1>Sangeet</h1>
